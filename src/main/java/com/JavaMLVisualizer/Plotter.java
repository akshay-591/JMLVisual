...
class Plotter {
    ...
    private final JML2DPlot jmlPlot;
    //Constructor
   ...
   void frame(Visual chart){
    ...
    Visual combinedCharts(ArrayList<DefaultXYDataset> xylist, String[] shapes, float[] lengths, float[] widths, Color...colors)  {
        ...
        if(jmlPlot.xMin!=0&&jmlPlot.xMax!=0){domain1.setRange(jmlPlot.xMin,jmlPlot.xMax);}else {domain1.setAutoRange(true);}
        if(jmlPlot.yMin!=0&&jmlPlot.yMin!=0){range1.setRange(jmlPlot.yMin,jmlPlot.yMax);}else {range1.setAutoRange(true);}
        ...
        for(int j=0;j<xylist.size();j++){
            ...
            switch (shape) {
                ...
                case JML2DShapes.SHAPE_LINE:
                    ...
                    //renderer1.setSeriesShape(j,new Rectangle(5,5)); this line is useful is user wants print shapes along the line
                    //renderer1.setSeriesShapesVisible(j,true);
                    if(color!=null){renderer1.setSeriesPaint(j,color);}
                ...
                case JML2DShapes.SHAPE_BAR:
                    ...
                    if(color!=null){renderer2.setSeriesPaint(j,color);}
